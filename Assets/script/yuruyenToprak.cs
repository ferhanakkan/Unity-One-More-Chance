...
public class yuruyenToprak : MonoBehaviour
{
    ...
    void noktalaraGit()
    {
        ...
        transform.position += aradakiMesafe * Time.deltaTime * 7;
        if (mesafe < 0.5f)
        {
...
#if UNITY_EDITOR
[CustomEditor(typeof(yuruyenToprak))]
[System.Serializable]
class yuruyenEditor : Editor
{

    public override void OnInspectorGUI()
    {
        yuruyenToprak script = (yuruyenToprak)target; // ust classtaki değişkenlere ulasmamı sağlar
