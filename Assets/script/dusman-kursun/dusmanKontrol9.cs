...
public class dusmanKontrol9 : MonoBehaviour
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(dusmanKontrol9))]
[System.Serializable]
class dusmanKontrol9Editor : Editor
{

    public override void OnInspectorGUI()
    {
        dusmanKontrol9 script = (dusmanKontrol9)target; // ust classtaki değişkenlere ulasmamı sağlar
