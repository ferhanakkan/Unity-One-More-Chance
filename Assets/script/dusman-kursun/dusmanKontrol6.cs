...
public class dusmanKontrol6 : MonoBehaviour
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(dusmanKontrol6))]
[System.Serializable]
class dusmanKontrol6Editor : Editor
{

    public override void OnInspectorGUI()
    {
        dusmanKontrol6 script = (dusmanKontrol6)target; // ust classtaki değişkenlere ulasmamı sağlar
