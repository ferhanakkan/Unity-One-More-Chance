...
public class dusmanKontrol2 : MonoBehaviour
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(dusmanKontrol2))]
[System.Serializable]
class dusmanKontrol2Editor : Editor
{

    public override void OnInspectorGUI()
    {
        dusmanKontrol2 script = (dusmanKontrol2)target; // ust classtaki değişkenlere ulasmamı sağlar
