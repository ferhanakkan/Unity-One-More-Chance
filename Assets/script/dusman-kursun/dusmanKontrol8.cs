...
public class dusmanKontrol8 : MonoBehaviour
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(dusmanKontrol8))]
[System.Serializable]
class dusmanKontrol8Editor : Editor
{

    public override void OnInspectorGUI()
    {
        dusmanKontrol8 script = (dusmanKontrol8)target; // ust classtaki değişkenlere ulasmamı sağlar
