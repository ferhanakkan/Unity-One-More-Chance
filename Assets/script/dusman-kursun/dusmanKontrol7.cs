...
public class dusmanKontrol7 : MonoBehaviour
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(dusmanKontrol7))]
[System.Serializable]
class dusmanKontrol7Editor : Editor
{

    public override void OnInspectorGUI()
    {
        dusmanKontrol7 script = (dusmanKontrol7)target; // ust classtaki değişkenlere ulasmamı sağlar
