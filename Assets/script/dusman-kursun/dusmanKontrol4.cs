...
public class dusmanKontrol4 : MonoBehaviour
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(dusmanKontrol4))]
[System.Serializable]
class dusmanKontrol4Editor : Editor
{

    public override void OnInspectorGUI()
    {
        dusmanKontrol4 script = (dusmanKontrol4)target; // ust classtaki değişkenlere ulasmamı sağlar
