...
public class dusmanKontrol3 : MonoBehaviour
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(dusmanKontrol3))]
[System.Serializable]
class dusmanKontrol3Editor : Editor
{

    public override void OnInspectorGUI()
    {
        dusmanKontrol3 script = (dusmanKontrol3)target; // ust classtaki değişkenlere ulasmamı sağlar
